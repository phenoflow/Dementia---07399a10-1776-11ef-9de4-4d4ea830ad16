...
steps:
  ...
  dementia-letter---primary:
    run: dementia-letter---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-excepted---primary:
    run: dementia-excepted---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-letter---primary/output
  subcortical-dementia---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-excepted---primary/output
  ...
  dementia-monitoring---primary:
    run: dementia-monitoring---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  vascular-dementia---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-monitoring---primary/output
  ...
  dementia-invite---primary:
    run: dementia-invite---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dementia-indicator---primary:
    run: dementia-indicator---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-invite---primary/output
  dementia-uncomplicated---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-indicator---primary/output
  dementia-history---primary:
    run: dementia-history---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dementia-history---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
